...
; adj.py from a running game. Neither is hand-written.
                    ORG     $6000
                    INCLUDE "knightlore/room_data.s"
                    INCLUDE "knightlore/panel_data.s"
                    INCLUDE "knightlore/sprite_adj_gen.s"
...
font:               INCBIN  "knightlore/font.bin"
...
special_where_start: INCBIN "knightlore/specials.bin", 0, 32 * 4
special_where:      DS      32 * 4              ; where they are now: special_init copies
special_wanted:     INCBIN  "knightlore/specials.bin", 32 * 4, 14
special_gfx:        DS      32
...
sprite_start:
					INCLUDE "knightlore/sprite_data.s"
sprite_end:
					...
					INCLUDE "knightlore/end.s"
					INCLUDE "knightlore/menu.s"
					INCLUDE "knightlore/input.s"
...
; the room data and the code -- see there for why.
					...
					INCLUDE "knightlore/main.s"
					INCLUDE "engine/turn.s"
					INCLUDE "knightlore/player.s"
					INCLUDE "knightlore/sun.s"
					INCLUDE "engine/redraw.s"
					INCLUDE "knightlore/overlay.s"	; redraw_view falls into it
...
bit_reverse_table:
                    ...
                    ALIGN   512
                    INCLUDE "knightlore/sprite_table.s"
