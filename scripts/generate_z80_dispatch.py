...
The former Rust core's dispatch table was generated by an earlier version of
this script; that core has since been removed.
...
# hand-written in z80.cpp (its PC-rewind trick doesn't fit the generic
...
SKIP_NAMES = {
    ...
    # the former Rust core's plan): ZEXALL's own shared per-iteration test harness does
...
# dispatched into by the hand-written CB fetch machine cycle in z80.cpp.
